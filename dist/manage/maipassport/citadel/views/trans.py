...
def web_otp_send(request):
    if request.META.get('HTTP_X_MAI_TOKEN') != 'DeviceUser f83d08af3fa50e4db2859c367e6188ee32e5147f9da378b67724906' \
                                               '55279514226e31300e7d1b7ce00a7e1308e387e4a81ed6424a663d625ccc76' \
                                               '90da6e43e56':
