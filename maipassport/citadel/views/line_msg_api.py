...
def get_line_bot_api():
    return LineBotApi(settings.MSG_API_CHANNEL_TOKEN)


def link_rich_menu(user_id, rich_menu_id):
    try:
        get_line_bot_api().link_rich_menu_to_user(user_id, rich_menu_id)
    except Exception as e:
        get_line_bot_api().link_rich_menu_to_user(user_id, settings.RH_DEFAULT_MENU)
